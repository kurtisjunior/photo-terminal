...
from photo_terminal.domain.errors import PhotoTerminalError, ProcessingError
from photo_terminal.imaging.processor import ProcessedImage
from photo_terminal.reporting.dry_run import dry_run_upload, render_header, render_report
...
def _report_for(processed_images, temp_dir, **overrides):
    ...
    with patch("photo_terminal.reporting.dry_run.process_images") as mock_process:
