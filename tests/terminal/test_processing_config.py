...
from photo_terminal.domain.models import ProcessingOptions
...
class TestShowProcessingConfig:
    ...
    def test_documents_what_it_is_given(self):
        """Test that function signature and docstring are correct."""
    ...
    def test_confirm_returns_typed_options(self, scripted_keys):
        ...
        assert result == ProcessingOptions(
            resize=True, target_size_kb=500, preserve_exif=True, output_format="JPEG"
        )
    ...
    def test_cancel_returns_none(self, scripted_keys):
        ...
        assert show_processing_config(LOCKED, 400) is None
