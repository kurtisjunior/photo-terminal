...
def test_cli_integrates_with_config(
    ...
    test_cfg = Config(bucket="test-bucket", aws_profile="test-profile", target_size_kb=300)
...
def test_cli_overrides_config_values(
    ...
    test_cfg = Config(bucket="default-bucket", aws_profile="default-profile", target_size_kb=400)
...
def test_dry_run_flag_integration(
    ...
    test_cfg = Config(bucket="test-bucket", aws_profile="test-profile", target_size_kb=400)
