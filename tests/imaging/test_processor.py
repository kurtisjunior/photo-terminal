...
from photo_terminal.imaging.processor import (
...
def test_process_images_success(sample_images, mock_optimize_result):
    ...
    with patch("photo_terminal.imaging.processor.optimize_image") as mock_optimize:
...
def test_check_disk_space_sufficient():
    ...
    with patch("photo_terminal.imaging.processor.shutil.disk_usage") as mock_disk_usage:
