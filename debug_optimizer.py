...
with tempfile.TemporaryDirectory() as tmpdir:
    ...
    result = optimize_image(
        input_path, output_path, target_size_kb=400, output_format="JPEG", max_dimension=1920
    )
    ...
    print(
        f"Original dims:     {result['original_dimensions'][0]} x {result['original_dimensions'][1]}"
    )
    ...
    if result["final_size"] > 400 * 1024:
        ...
        print("✓ PASSED: Final size respects 400KB limit")
